...
const BLOG = {
  AUTHOR: 'xiongus', // 作者
  BIO: '一个普通人', // 作者简介
  LINK: 'https://blog.xiongguisheng.com', // 网站地址
  KEYWORDS: 'Notion, Blog', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '89eede3e1fcb4d5693fd8d7c11702555', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'blog@xiongguisheng.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/xiongus', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/xiongus', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || "Gus's Blog", // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Home', // 站点描述，被notion中的页面描述覆盖
